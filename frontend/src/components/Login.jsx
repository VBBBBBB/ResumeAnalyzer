...
export default function Login() {
    ...
    const handleSuccess = async (credentialResponse) => {
        try {
            setError(null);
            setStatus('Step 1: Contacting your AWS Server...');
            ...
            setStatus(null);
            setError(err.response?.data?.detail || err.message || 'Verification Failed - Connection Issue');
        }
    };
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                textAlign: 'center', border: '1px solid #30363d', width: '380px'
            }}>
